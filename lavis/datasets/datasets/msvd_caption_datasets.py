...
class MSVDCapDataset(VideoCaptionDataset):
    ...
    def __getitem__(self, index):
        ...
        segment_list = np.linspace(0, ann['frame_length']-1, self.num_frames + 1, dtype=int)
        ...
        for frame_index in selected_frame_index:
            ...
            #ten_path=os.path.join(self.vis_root[:-6]+'tensor', ann['video'])+'.pt'
            #frame=torch.load(ten_path)[frame_index,:,:]
