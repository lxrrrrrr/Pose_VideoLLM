...
torchrun --nproc_per_node=1 \
    ...
    run.prefix test \
    run.resume_ckpt_path /workspace/MA_LMM/lavis/output/msvd_caption/blip2_vicuna_instruct_vicuna7b/train/b96_e10_lr1e-05_wd0.05_q32_f80_fb40_freezevit/checkpoint_best.pth
